...
def call(String ETL_REPO, String VDM_REPO, String MAPRO_REPO, String SEARCH_REPO) {
    ...
    emailext attachLog: false, attachmentsPattern: '*.LOG', mimeType: 'text/html', body: """<!DOCTYPE html>
		...
		""", subject: "CI: Project Name -> / ${env.JOB_BASE_NAME} / Module: ${params.ModuleType} /build status on /${params.Branch} / branch is ${currentBuild.currentResult}", to: "gmekala@taxilla.com"
}
