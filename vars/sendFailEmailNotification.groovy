...
def call() {
    BG_Color = "#8B0000"
    Log = "true"
    emailext attachLog: true, attachmentsPattern: '*.LOG', mimeType: 'text/html', body: """<!DOCTYPE html>
		<html>
			<head>
				<style>
					 table.blueTable {
		...
		""", subject: "\"ERROR CI: Project Name -> / ${env.JOB_BASE_NAME} / Module: ${params.ModuleType} /build status on /${params.Branch} / branch is Failed", to: '$DEFAULT_RECIPIENTS'
